...
- [`course`](https://ez.analog.com/webinar/c/e/101) **Signal Integrity: Optimizing RF Signal Chains** - A single and long webinar provided by Analog Devices Inc. It covers many technical and theoretical aspects of radiofrequency front-end (RF-FE) signal chains. It also mentions ADALM-PLUTO SDR, a software-defined radio deviced manufactured by this company and extensively used for learning purposes by hobbists and students.
