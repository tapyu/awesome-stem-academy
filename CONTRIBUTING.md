...
- In some cases, you might want to use multiple tags in the same item. For instance, if you have a link to a book, to its solution manual, and to its code solution, you can suggest something like:<br><br>
